    ...
    <Router>
      ...
      <main className="py-3">
        <Container>
          ...
          <Route path="/admin/catList" component={CatListScreen} />
          <Route path="/admin/cats" component={ProductCategoriesScreen} />
          <Route path="/admin/productTypes" component={productTypesScreen} />
